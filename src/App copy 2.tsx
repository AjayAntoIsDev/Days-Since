...
import Tornado from "./pages/Typhoon";
...
import GeomagneticStorm from "./pages/GeomagneticStorm";
import Asteroid from "./pages/Asteroid";
import VolcanicEruption from "./pages/VolcanicEruption";
            ...
            {!loading && !error && data && (
                <>
                    <Swiper
                        ...
                        <SwiperSlide>
                            <SolarFlare data={data} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <Tornado data={data} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <GeomagneticStorm data={data} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <Asteroid data={data} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <VolcanicEruption data={data} />
                        </SwiperSlide>
                    </Swiper>
